...
<p align="center">
  <a href="https://joisun.github.io/newspaperui/">
    <img src=".github/assets/newspaperui-homepage.png" width="1200" alt="NewspaperUI data edition: editorial line, bar and donut charts in the first homepage slide">
  </a>
</p>
...
Visit the documentation in [中文](https://joisun.github.io/newspaperui/) or [English](https://joisun.github.io/newspaperui/en/) for component APIs, layout guides, complete editions, and theming. The homepage opens with a live data edition featuring line, bar and donut charts, with links to the complete Block and chart APIs. Both languages use stable, shareable URLs and can be switched from the site header. The repository also includes an optional [NewspaperUI agent skill](SKILL.md) for coding assistants.
